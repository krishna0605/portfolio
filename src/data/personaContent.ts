...
export const engineerProjects = [
  ...
  },
  {
    ...
    description: "Developed an AI-driven platform to detect malware, steganography, and network threats using ML and YARA rules. Features a RESTful API and interactive dashboard for file scanning and security rule management.",
    tag: "AI + Security",
...
export const skills = {
  engineer: {
    ...
    categories: [
      ...
      { name: "Security", items: ["YARA", "Malware Analysis", "Threat Detection", "Network Security"] },
    ],
  },
  creative: {
    title: "Creative",
